...
const Activity: React.FC<ActivityProps> = ({ transactions }) => {
  ...
  return (
    <div className="flex flex-col p-6 md:p-8 animate-in slide-in-from-right duration-300">
      ...
      <div className="flex flex-col gap-1 bg-white md:bg-gray-50/50 md:rounded-[32px] md:p-4 md:border md:border-gray-100">
